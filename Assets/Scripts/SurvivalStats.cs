...
public class SurvivalStats : MonoBehaviour
{
    ...
    public float maxHunger = 100;         //최대허기량
    public float currentHunger;           //현재허기량
    ...
    private void CheckDeath()                          //플레이어 사망처리 체크함수
    {
    ...
    private void PlayerDeath()                          //플레이어 사망처리 함수
    {
        isGameOver = true;
        Debug.Log("플레이어 사망");
        //TODO : 사망 처리 추가(게임오버 UI, 리스폰 등)
    }
    ...
    {
        return (currentSuitDurability / maxSuitDurability) * 100f;
    }

    public bool IsGameOver()                          //게임종료 확인 함수
    {
        return isGameOver;
    }
